...
await testStep('processPayment should work with PayPal', async () => {
	...
	expect(result, '🚨 processPayment() should return "Paid $50 with PayPal user@example.com" - check your function accepts PaymentMethod type').toBe('Paid $50 with PayPal user@example.com')
})
